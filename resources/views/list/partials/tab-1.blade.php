...
<div class="col-md-12" style="margin-top: 30px;">
	<table class="table table-bordered" ng-if="terrains.length > 0" style="background: white;">
		...
		<tbody>
			<tr ng-repeat="terrain in terrains | filter: { title: f_title}" ng-click="edit(terrain)">
				<td >@{{ terrain.title }}</td>
				<td>@{{ terrain.pret }}</td>
				<td>@{{ terrain.suprafata }}</td>
				<td style="cursor: pointer;" ><a href="" class="btn btn-sm"><i class="fa fa-info" title="Click pentru a vedea mai multe detalii"></i></a> </td>
