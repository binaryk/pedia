...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <body>
	...
	<!--[if lte IE 7]>
	    <p class="browsehappy">You use a  <strong>old navigator</strong>.Please change it <a
                href="http://browsehappy
	    .com/">You can try</a> to continue your navigation.</p>
	<![endif]-->
